...
Stats null; // for updating rank with null stats
...
void ClientCommand( edict_t *pEntity ) {
	...
	if (!stricmp(szArg, "fullupdate")) {
		MODE_FULLUPDATE[ENTINDEX(pEntity)] = true;
	}
...
void ClientCommand_Post( edict_t *pEntity ) {
	MODE_FULLUPDATE[ENTINDEX(pEntity)] = false;
	RETURN_META(MRES_IGNORED);
}
